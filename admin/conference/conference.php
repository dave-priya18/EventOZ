<?php
    if(isset($_GET['msg']=="error")){
        $error = "The id you passed is not records.";
    }
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        while($rows = mysqli_fetch_assoc($fetch_conference_data)){ ?>
                            ...
                            <tr>
                                ...
                                Edit </a>
                                <!-- <?php
                                    echo "<a href='conference_manipulation.php?id=" . $rows['conference_id'] ."'>Delete</a>"; ?> -->
                                <input type="submit" value="Delete Conference" class="btn btn-info btn-fill pull-right" name="delete_conference"
                                onclick="return confirm('Are you sure about deleting the record?');">
                                </td>
                            </tr>
                            </tbody>
